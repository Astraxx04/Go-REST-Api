...
func registerForEvent(context *gin.Context) {
	...
	if(err != nil) {
		context.JSON(http.StatusInternalServerError, gin.H{"messaage": "Could not register for event"})
		return
	}
...
func cancelRegistration(context *gin.Context) {
	...
	if(err != nil) {
		context.JSON(http.StatusInternalServerError, gin.H{"messaage": "Could not cancel registration"})
		return
	}
